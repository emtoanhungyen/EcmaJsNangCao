...
const edit = {
                    ...
                    <form action="#" method="POST" id="form-edit">
                        <div class="shadow sm:rounded-md sm:overflow-hidden">
                            ...
                            <div class="">
                                ...
                                <input type="text" class="border border-gray-300 rounded-md w-full h-[35px] hover:border-red-300" value="${data.name}" id="add-name">
                            </div>
                
                            <div>
                                <label for="about" class="block text-sm font-medium text-gray-700"> Desc </label>
                                <div class="mt-1">
                                    <textarea id="add-desc" name="about" rows="3" class="shadow-sm focus:ring-indigo-500 focus:border-indigo-500 mt-1 block w-full sm:text-sm border border-gray-300 rounded-md" placeholder="Description">${data.desc}</textarea>
                                </div>
                            </div>
                            ...
                            <div>
                                ...
                                <div class="space-y-1 text-center">
                                    ...
                                    <img src="${data.img}">
                                    <input id="add-img" name="file" type="file" >
    ...
    afterRender(id){
        ...
        formEdit.addEventListener('submit', async function(e){
            ...
            const { data } = await axios.put(CLOUDINARY_API_URL,formData, {
                headers: {
